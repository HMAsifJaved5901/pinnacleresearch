    ...
    <div class="page-holder custom-page-template page-full fullscreen-page home-page-content clearfix">
        ...
        <section class="section-holder">
            <div class="row no-gutters">
                <div class="col-md-6">
                    <img class="img-fluid" src="{{ asset('assets/images/home/office-1-1.jpg') }}" alt=""/>
                </div>
                <div class="col-md-6">
                    <img class="img-fluid" src="{{ asset('assets/images/home/office-2-1.jpg') }}" alt=""/>
                </div>
            </div>
            <!-- /row -->
        </section>
        ...
        <section class="section-holder">
            <div class="container">
                ...
                <!-- /row -->
                <div class="view-more alignc margin-t72"><a href="#">View More</a></div>
            </div>
            <!-- /container -->
        </section>
        <!-- /SECTION 3-->
        <!-- SECTION 4-->
        <section class="parallax section-holder" style="background-image:url('{{ asset('assets/images/home/home-bkg-1.jpg') }}');">
        ...
        <section class="section-holder">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="lawyer-holder lawyer-3col">
                            <a href="#"><img src="{{ asset('assets/images/team/team-4.jpg') }}" class="img-fluid" alt="" ></a>
                            <div class="lawyer-position">Founder</div>
                            <h2 class="lawyer-title"><a href="#">Sarah Barrett</a></h2>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="lawyer-holder lawyer-3col">
                            <a href="#"><img src="{{ asset('assets/images/team/team-6.jpg') }}" class="img-fluid" alt="" ></a>
                            <div class="lawyer-position">Senior Partner</div>
                            <h2 class="lawyer-title"><a href="#">Mike Holmes</a></h2>
                            <div class="lawyer-excerpt">Integer imperdiet purus urna, a volutpat turpis feugiat vitae. Proin molestie in metus eu volutpat. Vestibulum vitae orci sit amet.</div>
                            <ul class="lawyer-social">
                                <li><a href="#" target="_blank"><i class="fab fa-twitter"></i></a></li>
                                <li><a href="#" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="lawyer-holder lawyer-3col">
                            <a href="#"><img src="{{ asset('assets/images/team/team-1.jpg') }}" class="img-fluid" alt="" ></a>
                            <div class="lawyer-position">Lawyer</div>
                            <h2 class="lawyer-title"><a href="#">Teresa Perkins</a></h2>
                            <div class="lawyer-excerpt">Integer imperdiet purus urna, a volutpat turpis feugiat vitae. Proin molestie in metus eu volutpat. Vestibulum vitae orci sit amet.</div>
                            <ul class="lawyer-social">
                                <li><a href="#" target="_blank"><i class="fab fa-twitter"></i></a></li>
                                <li><a href="#" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                ...
                <!-- /row -->
                <div class="view-more alignc"><a href="#">View More</a></div>
            </div>
            <!-- /container -->
        </section>
        <!-- /SECTION 5-->
                        ...
                        <div class="testimonials-container">
                            <div class="owl-carousel owl-theme testimonials-slider">
                                <div class="testimonial-item">
                                    ...
                                    <div class="testimonial-client"> <img src="{{ asset('assets/images/testimonials/client-1.jpg') }}" alt=""></div>
                                ...
                                <div class="testimonial-item">
                                    ...
                                    <div class="testimonial-client"> <img src="{{ asset('assets/images/testimonials/client-2.jpg') }}" alt=""></div>
                                ...
                                <div class="testimonial-item">
                                    ...
                                    <div class="testimonial-client"> <img src="{{ asset('assets/images/testimonials/client-3.jpg') }}" alt=""></div>
                                ...
                                <div class="testimonial-item">
                                    ...
                                    <div class="testimonial-client"> <img src="{{ asset('assets/images/testimonials/client-4.jpg') }}" alt=""></div>
                ...
                <div class="row section-home-blog">
                    <div class="col-md-4">
                        <article class="blog-item blog-item-2col-grid blog-item-3col-grid">
                            <a href="#">
                                <div class="post-image"><img src="{{ asset('assets/images/blog/blog-1.jpg') }}" class="img-fluid" alt=""></div>
                            </a>
                            <ul class="blog-date">
                                <li class="meta-date">October 10, 2019</li>
                                <li class="meta-categ"> <a href="#">Car Accidents</a> <a href="#">News</a></li>
                            </ul>
                            <div class="post-holder">
                                <h2 class="blog-title"><a href="#">Thinking Out Of The Box After A Simple Car Accident</a></h2>
                    ...
                    <div class="col-md-4">
                        <article class="blog-item blog-item-2col-grid blog-item-3col-grid">
                            <a href="#">
                                <div class="post-image"><img src="{{ asset('assets/images/blog/blog-2.jpg') }}" class="img-fluid" alt=""></div>
                            </a>
                            <ul class="blog-date">
                                <li class="meta-date">October 9, 2019</li>
                                <li class="meta-categ"> <a href="#">Divorce</a> <a href="#">News</a></li>
                            </ul>
                            <div class="post-holder">
                                <h2 class="blog-title"><a href="#">Understanding Domestic Violence Defense</a></h2>
                                <div class="article-excerpt">Arnare varius mauris eu commodo. Aenean nibh risus, rhoncus eget consectetur ac. Consectetur adipiscing elit. Vivamus auctor condimentum sem et gravida. Maecenas id enim pharetra.</div>
                            </div>
                        </article>
                    </div>
                    <div class="col-md-4">
                        <article class="blog-item blog-item-2col-grid blog-item-3col-grid">
                            <a href="#">
                                <div class="post-image"><img src="{{ asset('assets/images/blog/blog-9.jpg') }}" class="img-fluid" alt=""></div>
                            </a>
                            <ul class="blog-date">
                                <li class="meta-date">October 9, 2019</li>
                            ...
                            <div class="post-holder">
                                <h2 class="blog-title"><a href="#">How to Make a Claim Against an Airline</a></h2>
                                <div class="article-excerpt">Arnare varius mauris eu commodo. Aenean nibh risus, rhoncus eget consectetur ac. Consectetur adipiscing elit. Vivamus auctor condimentum sem et gravida. Maecenas id enim pharetra.</div>
                            </div>
                        </article>
                    </div>
        ...
        <!-- /SECTION 7-->
        <!-- SECTION 8-->
        <section class="parallax section-holder" style="background-image:url('{{ asset('assets/images/blog/blog-7.jpg') }}');">
            <div class="container parallax-content">
                <div class="row">
                    <div class="col-lg-10 offset-lg-1 alignc">
                        ...
                        <div class="view-more view-more-white margin-t54 alignc"><a href="#">Make an Appointment</a></div>
                    </div>
                </div>
                <!-- /row -->
            </div>
